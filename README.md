...
<div align="center"><img height="550" src="/images/web_config_page.png_v2"/>&emsp; </div>
...
|{"light_auto": [___m1___,___m2___]}| текущее значение PWM для подстройки границ изменения автоматической яркости|
|{"ambient_sens": [___a1___,___a2___]}| текущее значение границ входного сигнала сенсора освещенности (нормализация значений)|
