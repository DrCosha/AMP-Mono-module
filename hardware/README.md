...
Перечень элементов, примененных в схемах модуля CPU и платы питания представлен в файле [BOM AMP CPU & PM.csv](https://github.com/DrCosha/AMP-Mono-module/blob/master/hardware/BOM_AMP_CPU_&_PM_rev4.csv) и таблице ниже. Указанные элементы используются с печатными платами, __GERBER__ файлы которых приведены в разделе ___hardware___. При правильно собранных и подключенных модулях,
никаких дополнительных подстроек не нужно. Достаточно только прошить в микроконтроллер программу управления.

|N |Значение|Номера элементов|Тип элемента|Количество|
|--|----|----------|---------|--------|
|1 |0.1u |C1,C2,C3,C5,C6,C7,C9,C13,C16 |C0805 |9 |
|2 |0.1u |C12 |RAD-0.3 |1 |
|3 |220u x10V |C4 |CASE-D_7343 |1 |
|4 |22u x10V|C8 |CASE-C_6032 |1 |
|5 |1000u x25V |C10,C11 |CAP-D12.5×F5.0 |2 |
|6 |470u x16V |C14 |CASE-C_6032 |1 |
|7 |220u x16V |C15 |CASE-C_6032 |1 |
...
|18 |RESET |KEY1 |TS-1101 |1 |
|19 |FLASH |KEY2 |TS-1101 |1 |
...
- мощность __10VA__;
- входное напряжение __2*115V__, которые включены последовательно для обеспечения питания от __230V__;
- выходное напряжение __2*12V__, обмотки включены параллельно, для обеспечения максимального тока во вторичной обмотке.
