...
При указанных в таблице параметрах элементах, никаких дополнительных подстроек не нужно. Достаточно только прошить в микроконтроллер программу управления.
